...
namespace Blacksmiths.Tests.Wolf.EF.Models
{
    public partial class AdventureWorks2016Context : DbContext
    {
		...
		public virtual DbQuery<uspGetManagerEmployees> uspGetManagerEmployees { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			modelBuilder.Query<uspGetManagerEmployees>();//.Property(v => v.RecursionLevel).HasColumnName("RecursionLevel");
        }
    }
}
